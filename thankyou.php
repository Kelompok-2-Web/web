...
<head>
    ...
    <style>
        ...
        .thank-you-card {
            max-width: 400px;
            border-radius: 15px;
            background-color: #ffffff; /* Warna background kartu putih */
        ...
        .icon-success {
            width: 60px;
            height: 60px;
            color: #007bff; /* Warna ikon tanda centang biru */
        }
        ...
        .thank-you-text h1 {
            ...
            color: #007bff; /* Warna teks heading biru */
        }
        ...
        .thank-you-text .btn:hover {
            ...
            border-color: #0056b3; /* Warna border hover tombol biru yang lebih gelap */
        }
    </style>
</head>
        ...
        <div class="thank-you-card shadow-sm p-4">
            <div class="text-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-success" width="75" height="75"
                        fill="#007bff" class="bi bi-check-circle" viewBox="0 0 16 16">
