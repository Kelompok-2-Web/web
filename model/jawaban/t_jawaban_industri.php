...
class tJawabanIndustri
{
    ...
    public function getDataById($id)
    {
        ...
        $query = $this->db->prepare("select * from {$this->table} where jawaban_industri_id = ?");
    ...
    public function getDataByRespondenId($id)
    {
        ...
        // query untuk mengambil data berdasarkan id
        $query = $this->db->prepare("select * from {$this->table} where reponden_industri_id = ?");
    ...
    public function updateData($id, $data)
    {
        ...
        $query = $this->db->prepare("update {$this->table} set responden_industri_id = ?, soal_id = ?, jawaban = ? where jawaban_industri_id = ?");

        // binding parameter ke query
        $query->bind_param('iisi', $data['responden_industri_id'], $data['soal_id'], $data['jawaban'], $id);
